    ...
    >
      ...
      <div ref="navContainer" @scroll="handleScroll" class="flex-1 overflow-y-auto px-4 py-4 space-y-1 custom-scrollbar">
        <template v-if="currentUserRole === 'super_admin'">
          <Link href="/platform" @click="closeMobileMenu" class="nav-link flex items-center" :class="[isSidebarCollapsed ? 'justify-center' : '', isUrl('/platform') && !isUrl('/platform/tenants') && !isUrl('/platform/billing') ? 'nav-active' : '']">
          ...
          <Link href="/platform/tenants" @click="closeMobileMenu" class="nav-link flex items-center" :class="[isSidebarCollapsed ? 'justify-center' : '', isUrl('/platform/tenants') ? 'nav-active' : '']">
            <svg class="w-5 h-5 shrink-0" :class="isSidebarCollapsed ? '' : 'mr-3 opacity-75'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
            <span v-show="!isSidebarCollapsed" class="whitespace-nowrap overflow-hidden transition-all">Tenants & Companies</span>
          </Link>
          <Link href="/platform/billing" @click="closeMobileMenu" class="nav-link flex items-center" :class="[isSidebarCollapsed ? 'justify-center' : '', isUrl('/platform/billing') ? 'nav-active' : '']">
            <svg class="w-5 h-5 shrink-0" :class="isSidebarCollapsed ? '' : 'mr-3 opacity-75'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            <span v-show="!isSidebarCollapsed" class="whitespace-nowrap overflow-hidden transition-all">Billing & Revenue</span>
          </Link>
          <Link href="/support" @click="closeMobileMenu" class="nav-link flex items-center" :class="[isSidebarCollapsed ? 'justify-center' : '', isUrl('/support') ? 'nav-active' : '']">
            ...
            <span v-show="!isSidebarCollapsed" class="whitespace-nowrap overflow-hidden transition-all">Global Support</span>
          </Link>
        </template>
        ...
        <template v-if="currentUserRole !== 'super_admin'">
          ...
          <Link v-if="['admin', 'manager', 'staff'].includes(currentUserRole)" href="/products" @click="closeMobileMenu" class="nav-link flex items-center" :class="[isSidebarCollapsed ? 'justify-center' : '', isUrl('/products') ? 'nav-active' : '']">
          ...
          <div v-if="['admin', 'manager'].includes(currentUserRole)" class="pt-4 mt-4 border-t border-primary-800/50 space-y-1">
            ...
            <Link v-if="['admin', 'manager'].includes(currentUserRole)" href="/billing" @click="closeMobileMenu" class="nav-link flex items-center" :class="[isSidebarCollapsed ? 'justify-center' : '', isUrl('/billing') ? 'nav-active' : '']">
              <svg class="w-5 h-5 shrink-0" :class="isSidebarCollapsed ? '' : 'mr-3 opacity-75'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
              <span v-show="!isSidebarCollapsed" class="whitespace-nowrap overflow-hidden transition-all">Billing & Plan</span>
            </Link>
          </div>
        </template>
      </div>
