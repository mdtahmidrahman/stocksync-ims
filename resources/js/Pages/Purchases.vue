        ...
        <table class="w-full text-left border-collapse">
          ...
          <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors" v-for="i in 5" :key="i">
              ...
              <td class="p-4 text-gray-900 dark:text-white font-medium whitespace-nowrap">${{ 1500 * i }}.00</td>
              <td class="p-4 text-gray-500 dark:text-gray-400 text-sm whitespace-nowrap">${{ (i % 2 === 0 ? 1500 : 500) * i }}.00</td>
              <td class="p-4">
