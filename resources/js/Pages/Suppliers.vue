    ...
    <Modal :show="showAddModal" @close="showAddModal = false">
      ...
      <template #footer>
        <div class="flex justify-end gap-2 w-full">
          ...
          <button @click="saveSupplier" type="button" :disabled="addForm.processing" class="px-4 py-2 text-sm font-semibold text-white bg-primary-600 hover:bg-primary-700 rounded-lg transition-colors shadow-sm disabled:opacity-50">Save</button>
        </div>
      </template>
    </Modal>
    ...
    <Modal :show="showEditModal" @close="showEditModal = false">
      ...
      <template #footer>
        <div class="flex justify-end gap-2 w-full">
          ...
          <button @click="updateSupplier" type="button" :disabled="editForm.processing" class="px-4 py-2 text-sm font-semibold text-white bg-primary-600 hover:bg-primary-700 rounded-lg transition-colors shadow-sm disabled:opacity-50">Update</button>
        </div>
      </template>
    </Modal>
